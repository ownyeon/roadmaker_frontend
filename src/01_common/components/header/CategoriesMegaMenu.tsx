...
import { categorieMegaMenuItems } from "../data/HeaderData";
import {
  isActiveLink,
...
interface CategoriesMegaMenuProps {
  setIsActiveParent: Dispatch<SetStateAction<boolean>>;
}

const CategoriesMegaMenu = ({ setIsActiveParent }:CategoriesMegaMenuProps) => {
