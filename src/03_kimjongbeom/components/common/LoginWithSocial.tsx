...
const LoginWithSocial = () => {
  return (
    <>
    <div className="row justify-content-center social">  {/* 가운데 정렬을 위해 row와 justify-content-center 사용 */}
      {/* 여백 */}
      <div className="col-1 mb-3"> {/* 각 버튼을 col-md-3로 설정하고 모바일에서 col-6으로 설정 */}
